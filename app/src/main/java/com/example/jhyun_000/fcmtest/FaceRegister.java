...
//            }
    ...
    public void uploadWithTransferUtility(Uri uri, final String uuid) {
        ...
        Log.i("20180528", "uri is : " + uri.toString());
...
//                    sendRegisterHttp(user_email, "user", imageuuids);
                    ...
                    if (threadNumber == 0) {
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(FaceRegister.this);

                        builder.setMessage("얼굴 등록 완료")
                                .setTitle("얼굴 등록")
